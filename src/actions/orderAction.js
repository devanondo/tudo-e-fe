...
export const createOrder = (order) => async (dispatch) => {
    try {
        ...
        const { data } = await apiInstance.post('order/new', order, config);
...
export const myOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await apiInstance.get('orders/me');
...
export const updateOrder = (id, order) => async (dispatch) => {
    try {
        ...
        const { data } = await apiInstance.put(`admin/order/${id}`, order, config);
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await apiInstance.delete(`admin/order/${id}`);
