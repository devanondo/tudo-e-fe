...
import { clearError, getAllCategory, getProduct } from '../../actions/productAction';
...
function Products() {
    ...
    const { error: categoryError, category } = useSelector((state) => state.getCategory);
    ...
    }, [dispatch, keyword, currentPage, price, categoryTitle, categoryError, alert, error]);
                        ...
                        {resultPerPage < productsCount && (
                            <div className="paginationBox">
                                ...
                                <Pagination
                                    ...
                                    firstPageText={<KeyboardDoubleArrowLeftIcon className="icon" />}
                                    lastPageText={<KeyboardDoubleArrowRightIcon className="icon" />}
                                    itemClass="page-item"
                                    linkClass="page-link"
