...
const MyOrders = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <div className={`cellWithStatus ${params.getValue(params.id, 'status')}`}>
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <Link className="tableLink" to={`/order/${params.getValue(params.id, 'id')}`}>
                        View
                    </Link>
                );
            },
    ...
    return (
        <div>
            ...
            {loading ? (
                ...
                <div>
                    <Header />
                    <SubHeader page={'Profile Page'} subPage={'Orders'} />
