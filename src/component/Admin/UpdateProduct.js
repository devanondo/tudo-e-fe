...
const UpdateProduct = () => {
    ...
    }, [dispatch, error, alert, params, isUpdated, params.id, product, updateError, categoryError]);

    let subCategory;
    if (categoryTitle) {
        subCategory = category && category.find((item) => item.title === categoryTitle);
    }
